import "./ToolsBarComponet.scss";

import React, { type JSX } from "react";
export type ToolsBarComponentProps = {
  options: string[];
 ...
 * @returns JSX.Element
 */
export const ToolsBarComponent: React.FC<ToolsBarComponentProps> = ({
  options = [],
  defaultComponentProps = <h1>No tabs founded</h1>,
}): JSX.Element => {
  return (
    <section className="tools-bar">
      <aside className="tools-bar-left">
        {options.length > 0
          ? options.map((o, i) => <div key={i}>{o}</div>)
          : defaultComponentProps}
      </aside>
      <aside className="tools-bar-right">
        <div className="ia">
          <svg
